...
const ApproverDashboard = () => {
  ...
  const navigateToAdminLeaveEntry = () => {
    navigate('/leave-entry');
  };

  const navigateToPendingExpenseApprovals = () => {
  ...
  return (
    <Container>
      <Header>
        <HeaderTitle>Approver's Dashboard</HeaderTitle>
        <NavLinks>
      ...
      <MainContent>
        <Button onClick={navigateToAdminLeaveEntry}>
          {name} Leave Entry
        </Button>
        <Button onClick={navigateToPendingExpenseApprovals}>
          Expense Approvals
        </Button>
      </MainContent>
    </Container>
